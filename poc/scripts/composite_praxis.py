#!/usr/bin/env python3
"""Composite the praxis gallery video from poc/out/praxis/shots.json.
Static figures (no push-in), PNG overlays (no drawtext), white letterbox, 16:9.
Output: poc/out/praxis/praxis_final.mp4
"""
import json, os, subprocess, sys

ROOT="/Users/batoolsalman/Downloads/Sensationalize Science"; os.chdir(ROOT)
BASE="poc/out/praxis"; SEG=f"{BASE}/segments"; OVL=f"{BASE}/overlays"
