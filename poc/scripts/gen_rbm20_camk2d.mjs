// Kling driver for the rbm20-camk2d gallery video — verbatim approved prompts.
// Reads poc/out/rbm20-camk2d/shots.json (kind:video) → poc/out/rbm20-camk2d/clips/. SPENDS.
...
console.log(`\n▶ Kling — ${vids.length} rbm20-camk2d shots\n`);
const manifest = [];
for (const s of vids) {
